...
const MealSingle = ({ meal }) => {
  ...
  instructions = instructions?.filter(instructions => instructions.length > 2);


  return (
    <div className='section-wrapper'>
      <div className='container'>
        <div className='breadcrumb bg-blue-france text-light-yellow'>
          ...
          <div className='details-head grid'>
            ...
            <div className='details-intro'>
              ...
              <div className='tags flex align-start flex-wrap'>
                  ...
                  <ul className='flex aling-center flex-wrap'>
                    {
                ...
                <ul className='grid'>
                  {
                    meal?.measures?.map((measure,idx)=>(
                      <li key={idx} className='fs-14 flex align-end'>
                        <span className='li-icon fs-12 text-blue-france'><FaUtensilSpoon/></span>
                        <span className='li-text fs-15 fw-6 op-09'>{measure} {meal?.ingredients[idx]}</span>
                      </li>
                    ))
                  }
                </ul>
                ...
                <ul className='grid'>
                  {
                    instructions?.map((instruction, idx) => (
                      <li key={idx} className='fs-14'>
                        <AiOutlineCheckCircle size={18} className='text-blue-france li-icon'/>
